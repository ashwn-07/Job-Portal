...
const [username] = useState(sessionStorage.getItem('userName'))
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="#">ICTAK Alumni Job Portal      </a>
    <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
      <span className="navbar-toggler-icon"></span>
    </button>
    
    <div className="collapse navbar-collapse float" id="navbarNavAltMarkup">
      <div className="navbar-nav">
        {/* <a className="nav-link active "  aria-current="page" href="/"  onClick={HandleLogout}>Log Out</a> */}
