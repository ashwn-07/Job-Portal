    ...
    <Container>
        <div className="About-us-section">
            ...
            <div className="About-us-second-section">
                <div className='row'>
                    <div className='col-md-4'>
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%' }} className='About-us-second-section-text'>
                            <div className='About-us-second-section-heading'>
                                <Typography variant='h4' className="About-us-second-section-title">
                                    Vision & Values
                                </Typography>
                            </div>
            ...
            <div className="About-us-fourth-section">
                <div className='row'>
                    <div className='col-md-6'>
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%' }} className='About-us-fourth-section-text'>
                            <div className='About-us-fourth-section-heading'>
                                <Typography variant='h4' className="About-us-fourth-section-title">
                                    Operating Units
                                </Typography>
                            </div>
                            <br /><br />
            ...
            <div className='About-us-commitee'>
                <div className='About-us-commitee-heading'>
                    <Typography variant='h4'className="About-us-commitee-title">
